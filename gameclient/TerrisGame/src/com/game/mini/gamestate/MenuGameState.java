...
public class MenuGameState extends GameState {
	...
	public MenuGameState(Activity base, Engine ebase) {
		super(base, ebase);
	}

	@Override
	public void CreateGameState() {
		CommonClass.PRINT_LOG("MenuGameState::CreateGameState()");
		
		this.setBackground(new ColorBackground(0.2f, 0.6f, 0.9f, 1.f));
		
		this.m_textureatlasMain = new BitmapTextureAtlas(64, 64, TextureOptions.BILINEAR_PREMULTIPLYALPHA);
		BitmapTextureAtlasTextureRegionFactory.setAssetBasePath("gfx/");
		this.m_regionMain = BitmapTextureAtlasTextureRegionFactory.createFromAsset(this.m_textureatlasMain, this.m_activityBase, "face_circle_tiled.png", 0, 0);
	...
	public void DestroyGameState() {
		CommonClass.PRINT_LOG("MenuGameState::DestroyGameState()");
